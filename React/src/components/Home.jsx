    ...
    <div>
      <div className="container px-4 py-5">
        <div className='container'>
          <div className="UN">
            <h1 className="pb-2 "><b>Objective</b></h1>
            <span className="parrafo d-block" style={{ textAlign: 'justify' }}>
        ...
        <div className="container px-4 py-5" id="custom-cards">
          ...
          <div className="UN">
            <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
              <div className="col">
                <div
                  ...
                  style={{ backgroundImage: 'url("/img/ONU-2.png")' }}
                >
            ...
            <span className=" texto d-block" style={{ textAlign: 'justify' }}>
